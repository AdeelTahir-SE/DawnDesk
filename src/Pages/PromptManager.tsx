...
export default function PromptManager() {
  ...
  const handleUseInChat = (text: string) => {
    navigate("/ai", { state: { initialPrompt: text } });
  };
          ...
          {filteredPrompts.map((prompt) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between border-t border-neutral-800/60 pt-3 gap-2">
                ...
                <button
                  onClick={() => handleUseInChat(prompt.content)}
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-yellow-400 text-black text-xs font-bold hover:bg-yellow-300 active:scale-[0.98] transition-all shadow-[0_0_10px_rgba(250,204,21,0.1)] hover:shadow-[0_0_15px_rgba(250,204,21,0.25)]"
                >
                  Use in Chat
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
