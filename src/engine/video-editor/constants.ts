...
export const EFFECT_DEFINITIONS: EffectDefinition[] = [
  ...
  { type: 'brightness-contrast', name: 'Brightness/Contrast', category: 'stylize', description: 'Adjust brightness and contrast', icon: 'Sun', defaultParams: [{ key: 'brightness', label: 'Brightness', type: 'number', value: 0, min: -100, max: 100, step: 1 }, { key: 'contrast', label: 'Contrast', type: 'number', value: 0, min: -100, max: 100, step: 1 }] },
  { type: 'grayscale',         name: 'Grayscale',          category: 'stylize', description: 'Convert to black and white',     icon: 'CircleDot',    defaultParams: [{ key: 'amount', label: 'Amount', type: 'number', value: 100, min: 0, max: 100, step: 1 }] },
  { type: 'sepia',             name: 'Sepia',              category: 'stylize', description: 'Vintage warm tone',              icon: 'Sun',          defaultParams: [{ key: 'amount', label: 'Amount', type: 'number', value: 100, min: 0, max: 100, step: 1 }] },
  { type: 'invert',            name: 'Invert',             category: 'stylize', description: 'Invert colors',                  icon: 'FlipHorizontal', defaultParams: [{ key: 'amount', label: 'Amount', type: 'number', value: 100, min: 0, max: 100, step: 1 }] },
  ...
  { type: 'zoom-effect',       name: 'Zoom',               category: 'perspective', description: 'Timed punch-in zoom',            icon: 'Focus',        defaultParams: [{ key: 'scale', label: 'Scale', type: 'number', value: 125, min: 25, max: 400, step: 1 }, { key: 'centerX', label: 'Center X', type: 'number', value: 50, min: 0, max: 100, step: 1 }, { key: 'centerY', label: 'Center Y', type: 'number', value: 50, min: 0, max: 100, step: 1 }] },
  { type: 'text-overlay',      name: 'Text Overlay',       category: 'generate', description: 'Timed text overlay',                icon: 'Layers',       defaultParams: [{ key: 'text', label: 'Text', type: 'text', value: 'Text overlay' }, { key: 'fontFamily', label: 'Font', type: 'select', value: 'Sora', options: ['Sora', 'Inter', 'Manrope', 'Arial', 'Georgia', 'Times New Roman', 'Courier New'] }, { key: 'fontWeight', label: 'Weight', type: 'select', value: '800', options: ['300', '400', '500', '600', '700', '800', '900'] }, { key: 'alignment', label: 'Align', type: 'select', value: 'center', options: ['left', 'center', 'right'] }, { key: 'fontSize', label: 'Size', type: 'number', value: 52, min: 8, max: 180, step: 1 }, { key: 'x', label: 'X', type: 'number', value: 50, min: 0, max: 100, step: 1 }, { key: 'y', label: 'Y', type: 'number', value: 50, min: 0, max: 100, step: 1 }, { key: 'color', label: 'Color', type: 'color', value: '#ffffff' }, { key: 'strokeEnabled', label: 'Stroke', type: 'boolean', value: false }, { key: 'strokeColor', label: 'Stroke Color', type: 'color', value: '#000000' }, { key: 'strokeWidth', label: 'Stroke Width', type: 'number', value: 3, min: 0, max: 18, step: 1 }, { key: 'shadowEnabled', label: 'Shadow', type: 'boolean', value: true }, { key: 'shadowColor', label: 'Shadow Color', type: 'color', value: '#000000' }, { key: 'shadowBlur', label: 'Shadow Blur', type: 'number', value: 8, min: 0, max: 40, step: 1 }, { key: 'shadowX', label: 'Shadow X', type: 'number', value: 0, min: -30, max: 30, step: 1 }, { key: 'shadowY', label: 'Shadow Y', type: 'number', value: 2, min: -30, max: 30, step: 1 }, { key: 'background', label: 'Background', type: 'color', value: '#000000' }, { key: 'backgroundOpacity', label: 'Bg Opacity', type: 'number', value: 35, min: 0, max: 100, step: 1 }, { key: 'backgroundPadding', label: 'Bg Padding', type: 'number', value: 14, min: 0, max: 60, step: 1 }] },
];
