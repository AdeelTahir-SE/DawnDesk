...
export default function WelcomeScreen({ appKey, title, description, children }: WelcomeScreenProps) {
  ...
  if (appKey === "project-manager") {
    content = {
      ...
      subtitle: "Plan, organize, and deliver shared project work with tasks, boards, roadmap, reports, and teammates.",
      features: [
        { icon: <LayoutList className="h-5 w-5 text-yellow-400" />, title: "Plan Clearly", desc: "Track backlog, boards, roadmap, and strategies." },
        { icon: <LineChart className="h-5 w-5 text-yellow-400" />, title: "Review Progress", desc: "Use dashboards and reports to inspect project state." },
        { icon: <Flag className="h-5 w-5 text-yellow-400" />, title: "Work Together", desc: "Invite members and keep project sections organized." },
      ],
    ...
    content = {
      ...
      subtitle: "Manage finance workspaces with accounts, transactions, budgets, invoices, reports, and members.",
      features: [
        { icon: <TrendingUp className="h-5 w-5 text-yellow-400" />, title: "Analyze Flow", desc: "Review dashboard totals, cash flow, and trends." },
        { icon: <Receipt className="h-5 w-5 text-yellow-400" />, title: "Track Records", desc: "Keep accounts, transactions, invoices, and bills organized." },
        { icon: <PieChart className="h-5 w-5 text-yellow-400" />, title: "Plan Ahead", desc: "Use budgets, goals, subscriptions, and reports." },
        { icon: <ShieldCheck className="h-5 w-5 text-yellow-400" />, title: "Share Access", desc: "Invite finance workspace members when cloud sync is configured." },
      ],
    ...
    content = {
      ...
      subtitle: "Capture notes, organize notebooks and tags, manage tasks, templates, backlinks, and graph views.",
      features: [
