...
.\scripts\release.ps1 `
  -Version 1.0.0 `
  -Tag v1.0.0 `
  -ReleaseTitle "DawnDesk v1.0.0 - Stable Desktop Release" `
  -NotesFile docs/releases/v1.0.0.md `
  -Draft
```
...
| `1.0.1` | Superseded | Patch release with updater overlay and desktop icon refresh. |
| `1.1.0` | Current | Cross-platform release setup for Windows and Linux builds. |
