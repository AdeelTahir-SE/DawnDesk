...
| # | Feature | Description | Version | Status |
|---|---------|-------------|---------|--------|
| 11 | Rectangular Marquee | Click-drag to select rectangular regions for isolated edits | `v0.1` | ✅ DONE |
| 12 | Elliptical Marquee | Oval/circle selections for round objects or circular crops | `v0.1` | ✅ DONE |
...
| # | Feature | Description | Version | Status |
|---|---------|-------------|---------|--------|
| 21 | Basic Brush Tool | Round/soft brush strokes on any layer with opacity control | `v0.1` | ✅ DONE |
...
| # | Feature | Description | Version | Status |
|---|---------|-------------|---------|--------|
| 41 | Grayscale / Desaturate | Convert image to black-and-white with luminance weighting | `v0.1` | ✅ DONE |
...
| # | Feature | Description | Version | Status |
|---|---------|-------------|---------|--------|
| 61 | Basic Text Overlay | Place a single-line text label on the image | `v0.1` | ✅ DONE |
| 62 | Font & Size Selector | Pick from system fonts and set point size | `v0.1` | ✅ DONE |
| 63 | Text Color | Choose fill color for text runs | `v0.1` | ✅ DONE |
